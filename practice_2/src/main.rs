// Rust program to calculate the area of a triangle given three_sides
...
fn main() 
{
    ...
    io: : stdin().read_line(&mut input1).expect("Not a valiod string");
    ...
    io: :stdin().read_line(&mut input3).except().expect("Not a valid string");
